<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    @auth
        @if(Auth::user()->Role === "Manager")
            <a href="{{ url('/') }}" class="btn btn-outline-light rounded-pill me-3  py-2 px-4 m-4 px-4">Dashboard</a>
        @endif
   ...
   Profile
        ...
        <!-- Logout Button -->
        <a href="{{ route('logout') }}" 
           class="btn btn-danger rounded-pill me-3  py-2 px-4 m-4 px-4" 
    ...
    @else
        ...
        <a href="{{ route('login') }}" class="btn btn-outline-primary rounded-pill me-3  py-2 px-4 m-4 px-4">Log In</a>

        @if (Route::has('register'))
            <a href="{{ route('register') }}" class="btn btn-outline-success rounded-pill  py-2 px-4 m-4 px-4">Register</a>
        @endif
    @endauth
@endif
