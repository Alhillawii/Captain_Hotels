          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			...
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="room-img" style="background-image: url(land/images/room-1.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="room-img" style="background-image: url(land/images/room-2.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="room-img" style="background-image: url(land/images/room-3.jpg);"></div>
          				</div>
          			</div>
          		</div>
          		...
          		<div class="col-md-12 room-single ftco-animate mb-5 mt-4">
          			...
          			<div class="block-16">
		              <figure>
		                <img src="land/images/room-4.jpg" alt="Image placeholder" class="img-fluid">
          		...
          		<div class="col-md-12 room-single ftco-animate mb-5 mt-5">
          			...
          			<div class="row">
          				<div class="col-sm col-md-6 ftco-animate">
				    				<div class="room">
				    					<a href="rooms.html" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(land/images/room-1.jpg);">
				    			...
				    			<div class="col-sm col-md-6 ftco-animate">
				    				<div class="room">
				    					<a href="rooms.html" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(land/images/room-2.jpg);">
				    						<div class="icon d-flex justify-content-center align-items-center">
				    							<span class="icon-search2"></span>
				    						</div>
				    					</a>
          ...
          <div class="col-lg-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(land/images/image_1.jpg);"></a>
                <div class="text">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(land/images/image_2.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                  <div class="meta">
                    <div><a href="#"><span class="icon-calendar"></span> July 12, 2018</a></div>
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(land/images/image_3.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                  <div class="meta">
                    <div><a href="#"><span class="icon-calendar"></span> July 12, 2018</a></div>
